...
<head>
	...
	<style>
		body {
			background: url(images/admin_loginbg.jpg) no-repeat center center fixed;
...
<body>
	...
	<form method="post" action="admin_login.php">
		...
		<div class="input-group d-flex justify-content-between">
			<button type="submit" class="btn btn-primary" name="login_user" id="login_user" hidden>Login</button>
		</div>
		<div class="d-flex justify-content-between">
			<a class="" href="login.php" role="button">Login as a student/ client</a>
			<a class="text-decoration-underline" style="color:crimson;" href="supervisor/supervisor_login.php" role="button">Login as a supervisor</a>
		</div>
		<p>
	...
	<script>
		...
		var loginBtn = document.querySelector("#login_user")
