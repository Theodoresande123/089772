...
<body>
    ...
    <br><br>
    <div class="container">
        <h2>List of Category B hostels</h2>
        <table class="table table-hover">
            ...
            <tbody>
                ...
                // $query="select * from hostels,category where category.hostel_id= hostels.hostel_id and category.category_id='2';";
                $query = "select * from hostels where category_id='0002'";
